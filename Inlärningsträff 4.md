...
> [!NOTE] Svar 18
> 1. Diffusion: $CO_2$ rör sig från högt tryck i arbetande celler till lägre tryck i vävnadskapillärerna. Tryckskillnaden är mindre än för syrgas, diffunderar CO2 mycket effektivt pga det är 20x mer lösligt i vätska än syre.
...
> 3. I lungorna: $P_{CO_2}$ är lägre i alveolerna än i blodet, och därför diffunderar löst koldioxid från blodet till alveolen. När detta sker går reaktionen i erytrocyten åt motsatt håll: $HCO_3^-$ går in i erytrocyten, omvandlas tillbaka till $CO_2$, som sedan diffunderar ut i alveolen och andas ut.
