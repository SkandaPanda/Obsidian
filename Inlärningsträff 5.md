...
### Fråga 20: Vilka latinska namn ska in på blodkärlen i nedanstående flödesscheman. Inkludera höger eller vänster i dina svar under flödesschema 1, 2 och 4.

1. Aortabågen $\to$ (A) $\to$ (B) $\to$ (C) $\to$ (D) $\to$ A. radialis dexter

2. Uppåtgående aortan $\to$ (A) $\to$ (B) $\to$ (C) $\to$ (D) $\to$ Vänster njure

3. Bukaortan $\to$ (A) $\to$ (B) $\to$ (C) $\to$ (D) $\to$ A. tibialis anterior

4. Truncus brachiocephalicus $\to$ (A) $\to$ (B) $\to$ A. cerebri media

5. A. subclavia sinister $\to$ (A) $\to$ (B) $\to$ A. cerebri posterior
